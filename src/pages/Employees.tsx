      ...
      <Card>
        {employees.length === 0 ? (
          <EmptyState
            ...
            description="Voeg uw eerste werknemer toe om te beginnen"
            action={
              <Button onClick={() => openModal()}>
                <Plus className="h-5 w-5 mr-2" />
                Nieuwe Werknemer
          ...
          <Table
            data={employees}
            columns={columns}
            onRowClick={(employee) => openModal(employee)}
          />
        )}
      </Card>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Input
                    ...
                    placeholder="Paspoortnummer of ID-nummer"
                  />
                </div>
              </div>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="zero_hours">0-urencontract</option>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      {DUTCH_CAOS.map((cao) => (
                        <option key={cao.code} value={cao.name}>
                          {cao.name}
                        </option>
                      ))}
                    </select>
                    {errors.cao && (
                      <p className="mt-1 text-sm text-red-600">{errors.cao.message}</p>
                    )}
                  </div>
                  <Input
                    label="CAO Code"
                    {...register('caoCode')}
                    value={selectedCAO ? DUTCH_CAOS.find(c => c.name === selectedCAO)?.code || '' : ''}
                    readOnly
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <Input
                    ...
                    min="0"
                    max="1"
                    disabled={watch('travelAllowanceType') !== 'per_km'}
                  />
                  <Input
                    label="Vast bedrag (€)"
                    type="number"
                    ...
                    step="0.01"
                    min="0"
                    disabled={watch('travelAllowanceType') !== 'fixed'}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Input
                    ...
                    placeholder="Naam van pensioenregeling"
                  />
                  <Input
                    label="Pensioenfonds"
                    {...register('pensionFund')}
                    placeholder="Naam van pensioenfonds"
                  />
                </div>
        ...
        <div className="space-y-4">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Het account voor {selectedEmployee?.personalInfo.firstName} {selectedEmployee?.personalInfo.lastName} is aangemaakt.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  readOnly
                  className="flex-1 px-3 py-2 border border-gray-300 rounded-l-md bg-gray-50 text-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400"
                />
                <Button
                  type="button"
                  variant="ghost"
                  size="sm"
                  onClick={() => navigator.clipboard.writeText(selectedEmployee?.personalInfo.contactInfo.email || '')}
                  className="border border-l-0 border-gray-300 rounded-l-none dark:border-gray-600"
                >
            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  readOnly
                  className="flex-1 px-3 py-2 border border-gray-300 rounded-l-md bg-gray-50 text-gray-900 font-mono dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                />
                <Button
                  type="button"
                  variant="ghost"
                  ...
                  className="border border-l-0 border-r-0 border-gray-300 rounded-none dark:border-gray-600"
                >
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                  <ul className="list-disc list-inside space-y-1">
                    <li>Deel deze inloggegevens veilig met de werknemer</li>
                    <li>Adviseer de werknemer om het wachtwoord direct te wijzigen</li>
                    <li>Dit wachtwoord wordt niet opnieuw getoond</li>
                  </ul>
                </div>
              </div>
            </div>
