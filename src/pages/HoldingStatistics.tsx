...
const HoldingStatistics: React.FC = () => {
  ...
  if (!selectedCompany) {
    return (
      <div className="p-6">
        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">Selecteer een holding of aandeelhouder om statistieken te bekijken.</p>
      </div>
    );
  }
  ...
  if (selectedCompany.companyType !== 'holding' && selectedCompany.companyType !== 'shareholder') {
    return (
      <div className="p-6">
        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">Deze pagina is alleen beschikbaar voor holdings en aandeelhouders.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">{pageDescription}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">Totale Winst</p>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">Aantal Bedrijven</p>
      ...
      <Card>
        ...
        {revenueChartData.length > 0 ? (
          ...
          <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500 text-center py-8">Geen data beschikbaar</p>
        )}
      </Card>
              ...
              {companyStats.map((stat) => (
                <tr key={stat.companyId} className="hover:bg-gray-50 dark:bg-gray-900">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-green-600 font-medium">
                    ...
                    <span className="text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500 ml-2">({stat.outgoingInvoicesCount})</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-red-600 font-medium">
                    €{stat.incomingInvoicesTotal.toLocaleString('nl-NL', { minimumFractionDigits: 2 })}
                    <span className="text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500 ml-2">({stat.incomingInvoicesCount})</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-600 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">
